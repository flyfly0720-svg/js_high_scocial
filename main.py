...
SITUATIONS = {
    ...
    "혈관미주신경성 실신": {
        "call_119": "처음 겪는 실신이거나 반복·외상 동반 시 119 신고 또는 병원 진료",
        "steps": [
            "시야가 흐려지거나 어지럽고 식은땀이 나며 창백해지는 전조증상이 느껴지면 즉시 앉거나 눕습니다.",
            "다리를 심장보다 높게 올려 뇌로 가는 혈류를 확보합니다.",
            "지하철 등 좁은 공간이라면 쪼그려 앉아 넘어져서 다치는 것을 예방합니다.",
            "넥타이, 벨트 등 조이는 옷차림을 느슨하게 풀어줍니다.",
            "의식을 회복해도 곧바로 일어나지 말고 충분히 누운 채 안정을 취합니다.",
            "실신이 반복되거나 외상을 동반하면 병원에서 심장·뇌 질환 여부를 확인합니다.",
        ],
        "cautions": [
            "실신 중에 경련성 움직임이 동반될 수 있으니 주변의 위험한 물건을 치웁니다.",
...
LOCATIONS = {
    ...
    "야외 / 등산": {
        "situations": ["열사병 / 온열질환", "출혈", "심정지 (심폐소생술)", "혈관미주신경성 실신"],
        "tips": [
